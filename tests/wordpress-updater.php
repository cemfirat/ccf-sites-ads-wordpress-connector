...
function wp_remote_get(string $url, array $options): array {
    ...
    if (($options['headers']['User-Agent'] ?? '') !== 'CCF-Sites-Ads-WordPress-Updater/1.1.1') {
        throw new RuntimeException('Updater user agent is missing.');
    }
    return [
        'response' => ['code' => 200],
        'body' => json_encode([
            'tag_name' => 'wordpress-v1.2.0',
            'html_url' => 'https://github.com/cemfirat/ccf-sites-ads-wordpress-connector/releases/tag/wordpress-v1.2.0',
            'draft' => false,
            'prerelease' => false,
            ...
            'assets' => [[
                ...
                'browser_download_url' => 'https://github.com/cemfirat/ccf-sites-ads-wordpress-connector/releases/download/wordpress-v1.2.0/ccf-sites-ads-connector.zip',
            ]],
        ], JSON_THROW_ON_ERROR),
    ];
}
...
if (!isset($GLOBALS['ccf_filters']['pre_set_site_transient_update_plugins'], $GLOBALS['ccf_filters']['plugins_api'])) {
    throw new RuntimeException('WordPress updater hooks were not registered.');
}

$transient = (object) [
    'checked' => ['ccf-google-ads-site-connector/ccf-google-ads-site-connector.php' => '1.1.1'],
    'response' => [],
];
$updated = CCF_Google_Ads_Site_Connector::check_for_update($transient);
$offer = $updated->response['ccf-google-ads-site-connector/ccf-google-ads-site-connector.php'] ?? null;
if (!is_object($offer) || $offer->new_version !== '1.2.0') {
    throw new RuntimeException('A newer stable release was not offered.');
}
if ($offer->package !== 'https://github.com/cemfirat/ccf-sites-ads-wordpress-connector/releases/download/wordpress-v1.2.0/ccf-sites-ads-connector.zip') {
